...
class prefsVP extends kupcGDocsVP
{
  /**
   * Konstruktor
  ...
  {
    $prefs = $this->getData('prefs');

    if (!$this->getData('internal'))
    {
      ...
      $cont .= '<div class="caption">Einstellungen f&uuml;r "<span id="prefFormArticle">'.$this->data['article'].'</span>"</div>'.
